...
VOLUNTARYCHECK=0
I=1
BOT=telediamond  # You can put here other bots. Also you can change it to run more than one bot in the same server.
...
while getopts ":tsTSih" opt; do
  case $opt in
	...
	echo -e "\e[1m"
	echo -e ""
	echo "steady.sh bash script v1 telediamond" >&2
	echo ""
	echo -e "\e[0m"
